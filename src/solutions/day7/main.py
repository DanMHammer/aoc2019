...
def operate(data, pointer, inputs, output):
...
def operation_loop(data, input1, input2):
    inputs = deque([input1, input2])
    output = 0
    pointer = 0
    while pointer >= 0:
        data, pointer, inputs, output = operate(data, pointer, inputs, output)
    return output
